...
<?php echo $error ?>
            ...
            <div class="social-media">
              <a href="https://www.facebook.com/profile.php?id=100070802592516&mibextid=ZbWKwL" class="social-icon">
                <i class="fab fa-facebook-f"></i>
              </a>
              <a href="https://twitter.com/AnushaSinghRaj3?t=QipPfATKinm6SCoNGtE57w&s=08" class="social-icon">
